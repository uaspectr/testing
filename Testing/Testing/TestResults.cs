...
namespace Testing
{
    public partial class TestResults : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "Дата(ДД.ММ.ГГГГ)")
            {
                string qry = "SELECT Пользователь,ID,Дата,Балл,Логин FROM Результаты_Теста WHERE Дата=" + "\"" + textBox1.Text + "\"";
            ...
            else if(comboBox1.Text =="Логин")
            {
                string qry = "SELECT Пользователь,ID,Дата,Балл,Логин FROM Результаты_Теста WHERE Логин=" + "\"" + textBox1.Text + "\"";
            ...
            {
                string qry = "SELECT Пользователь,ID,Дата,Балл,Логин FROM Результаты_Теста WHERE Пользователь=" + "\"" + textBox1.Text + "\"";
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            y = y + 40;
            x = x + 55;
            g.DrawString("Дата: ___________ ", font, brush, x, y);
            x = x + 250;
        ...
        private void dataGridView1_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1)
            {
                ...
                string qry_for_show_results = "select * from [Ответы1_3] where ID=" + "\"" + ID + "\"";
                string qry_for_show_results_part_2 = "select * from [Ответы2] where ID=" + "\"" + ID + "\"";
                string qry_for_show_results_part_3 = "select * from [Ответы3] where ID=" + "\"" + ID + "\"";
                string qry_for_count_1 = "SELECT COUNT(*) FROM [Ответы1_3] where ID=" + "\"" + ID + "\"";
                string qry_for_count_2 = "SELECT COUNT(*) FROM [Ответы2] where ID=" + "\"" + ID + "\"";
                string qry_for_count_3 = "SELECT COUNT(*) FROM [Ответы3] where ID=" + "\"" + ID + "\"";


                //Запрос к бд на ответы 1 части вопросов
                ...
                //Запрос к бд на ответы 2 части вопросов
                ...
                //Запрос к бд на овтеты 3 части вопросов
