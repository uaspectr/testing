namespace Testing
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.выгрузитьБазуВопросовToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.добавлениеВопросовToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.полнаяЗагрузкаToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.отдельныйВопросToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.выгрузитьБазуВопросовToolStripMenuItem,
            this.добавлениеВопросовToolStripMenuItem});
            ...
            // 
            // выгрузитьБазуВопросовToolStripMenuItem
            // 
            this.выгрузитьБазуВопросовToolStripMenuItem.Name = "выгрузитьБазуВопросовToolStripMenuItem";
            this.выгрузитьБазуВопросовToolStripMenuItem.Size = new System.Drawing.Size(214, 22);
            this.выгрузитьБазуВопросовToolStripMenuItem.Text = "Выгрузить базу вопросов";
            this.выгрузитьБазуВопросовToolStripMenuItem.Click += new System.EventHandler(this.выгрузитьБазуВопросовToolStripMenuItem_Click);
            // 
            // добавлениеВопросовToolStripMenuItem
            // 
            this.добавлениеВопросовToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.полнаяЗагрузкаToolStripMenuItem,
            this.отдельныйВопросToolStripMenuItem});
            this.добавлениеВопросовToolStripMenuItem.Name = "добавлениеВопросовToolStripMenuItem";
            this.добавлениеВопросовToolStripMenuItem.Size = new System.Drawing.Size(214, 22);
            this.добавлениеВопросовToolStripMenuItem.Text = "Добавление вопросов";
            // 
            ...
            // 
            // отдельныйВопросToolStripMenuItem
            // 
            this.отдельныйВопросToolStripMenuItem.Name = "отдельныйВопросToolStripMenuItem";
            this.отдельныйВопросToolStripMenuItem.Size = new System.Drawing.Size(179, 22);
            this.отдельныйВопросToolStripMenuItem.Text = "Отдельный вопрос";
            this.отдельныйВопросToolStripMenuItem.Click += new System.EventHandler(this.отдельныйВопросToolStripMenuItem_Click);
            // 
            // panel1
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem выгрузитьБазуВопросовToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem добавлениеВопросовToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem полнаяЗагрузкаToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem отдельныйВопросToolStripMenuItem;
