    ...
    public partial class Добавление_учетных_записей : Form
    {
       ...
       public  string connstring = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                string qry = "INSERT INTO [Авторизация] (Логин,Пароль,ФИО,Администрирование,Должность,[Структура теста]) Values (" + "\"" + Login.Text + "\"" + "," + "\"" + Password.Text + "\"" + "," + "\"" + FIO.Text + "\"" + "," + checkBox1.Checked + "," + "\"" + Status.Text + "\"" + "," + checkBox2.Checked + ")";
